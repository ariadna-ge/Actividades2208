...
public class ControladorEjemplo extends MouseAdapter {
    ...
    public ControladorEjemplo(Ventana view) {
        this.view = view;
        //conectar botones con el evento
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == view.getBtnMensaje()) {
            ...
            //crear icono desde archivo local
            ImageIcon icono = new ImageIcon("sucessIcon.png");

            //Contiene metodos estaticos (no necesita ser un objeto para mandar a llamar a objetos)
        ...
        if (e.getSource() == view.getBtnOpcion()) {
            ...
            //constate: tipo de opcion (boton a aparecer)
            if (respuesta == JOptionPane.YES_NO_OPTION) {
                view.getLblResultado().setText("Elegiste opcion YES");
            } else {
